...
End If
End Sub
Public Function FindProcessesWithChildWindows(ByVal hwnd As Long, lParam As Long) As Boolean
On Error Resume Next
Dim hWin As Long
Dim lpCaption As String
If (hwnd = Form1.hwnd) Or (hwnd = Form2.hwnd) Or (hwnd = Form3.hwnd) Or (hwnd = frmAbout.hwnd) Or (hwnd = Form5.hwnd) Then
FindProcessesWithChildWindows = True
Exit Function
End If
...
If lpszProcessName = App.EXEName & ".exe" Then
FindProcessesWithChildWindows = True
Exit Function
End If
If lpszProcessName = App.EXEName & ".EXE" Then
...
End If
Dim nLength As Long
nLength = Len(App.EXEName)
If LCase(Left(lpszProcessName, nLength)) = LCase(App.EXEName) Then
FindProcessesWithChildWindows = True
Exit Function
End If
If Form5.List2.ListCount = 0 Then
Form5.List2.AddItem lpszProcessName
FindProcessesWithChildWindows = True
Exit Function
End If
If Form5.List2.ListCount = 1 Then
If lpszProcessName <> Form5.List2.List(0) Then
Form5.List2.AddItem lpszProcessName
FindProcessesWithChildWindows = True
Exit Function
End If
...
Dim cunt As Integer
For cunt = 0 To Form5.List2.ListCount - 1
If lpszProcessName <> Form5.List2.List(cunt) Then
addvar = addvar + 1
If addvar = Form5.List2.ListCount Then
Form5.List2.AddItem lpszProcessName
FindProcessesWithChildWindows = True
Exit Function
addvar = 0
...
End Function
Public Function EnumProcessChildWindowsEx(ByVal hwnd As Long, lParam As Long) As Boolean
On Error Resume Next
On Error Resume Next
Dim hWin As Long
Dim lpCaption As String
If (hwnd = Form1.hwnd) Or (hwnd = Form2.hwnd) Or (hwnd = Form3.hwnd) Or (hwnd = frmAbout.hwnd) Or (hwnd = Form5.hwnd) Then
EnumProcessChildWindowsEx = True
Exit Function
End If
If (hwnd = Form1.hwnd) Or (hwnd = Form2.hwnd) Or (hwnd = Form3.hwnd) Or (hwnd = frmAbout.hwnd) Or (hwnd = Form5.hwnd) Or (hwnd = Child1.hwnd) Or (hwnd = Child2.hwnd) Then
EnumProcessChildWindowsEx = True
...
Dim lpszProcessName As String
Dim lpszProcessPath As String
Dim lpszWinCaption As String
GetWindowThreadProcessId hwnd, lpdwProcessId
GetProcessName lpdwProcessId, lpszProcessName, lpszProcessPath
If lpszProcessName = App.EXEName & ".exe" Then
EnumProcessChildWindowsEx = True
Exit Function
End If
...
Exit Function
End If
If lpszProcessName = Form5.List2.List(Form5.List2.ListIndex) Then
lpszWinCaption = GetPassword(hwnd)
If lpszWinCaption = "" Then
EnumProcessChildWindowsEx = True
Exit Function
End If
Form5.List1.AddItem lpszWinCaption
EnumProcessChildWindowsEx = True
End If
EnumProcessChildWindowsEx = True
End Function
